...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { biography: @actor.biography, dob: @actor.dob, name: @actor.name, rating: @actor.rating, view_count: @actor.view_count }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { biography: @actor.biography, dob: @actor.dob, name: @actor.name, rating: @actor.rating, view_count: @actor.view_count }
    assert_redirected_to actor_path(assigns(:actor))
  end
